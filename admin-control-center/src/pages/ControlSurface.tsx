...
import { Activity, ShieldAlert, MonitorCheck, Zap, Ghost, Database, Key, RefreshCcw, Power } from 'lucide-react';
...
export default function ControlSurface() {
  ...
  useEffect(() => {
    ...
    // Switch to real-time subscription via Firestore
    const unsubscribe = ClinicalEmitter.subscribeEvents((newEvents) => {
      setEvents(newEvents);
    });
